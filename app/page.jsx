...
//       <section className="flex-grow bg-gradient-to-br from-gray-900 via-purple-900 to-gray-800 text-white">
...
//             >
//               <span className="text-xl text-accent font-mono tracking-wider">SOFTWARE DEVELOPER</span>
//               <h1 className="h1 mb-6 mt-4">
//                 Hello, I am <br />
//                 <span className="text-accent bg-clip-text text-transparent bg-gradient-to-r from-accent to-purple-400">
//                   Achanya Suresh Puthiyottil
//                 </span>
//               </h1>
//               <p className="max-w-[500px] mb-9 text-white/80 text-lg leading-relaxed">
//                 I craft elegant digital experiences with clean, efficient code. Passionate about building responsive,
...
//                     variant="outline"
//                     size="lg"
//                     className="uppercase flex items-center gap-2 border-accent text-accent hover:bg-accent hover:text-primary transition-all duration-300 group"
//                   >
...
//                     className="w-12 h-12 border border-accent rounded-full flex justify-center items-center text-accent text-xl hover:bg-accent hover:text-primary transition-all duration-300"
//                     aria-label="GitHub"
//                     whileHover={{ y: -5 }}
//                   >
//                     <FaGithub />
...
//             {/* Photo Section */}
//             <motion.div
//               className="order-1 xl:order-none mb-8 xl:mb-0 relative"
...
//                 <Photo />
//               </div>
//               <div className="absolute inset-0 bg-accent/20 rounded-full blur-3xl -z-10 animate-pulse duration-3000"></div>
//             </motion.div>
//           </div>
//         </div>
...
//           <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 border-b border-accent/30 pb-4">
//             Featured Projects
//           </h2>
//           <Work />
//         </div>
